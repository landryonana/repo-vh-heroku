...
class Person(models.Model):
    ...
    contacts = models.PositiveIntegerField(unique=True)
    ...
    whatsapp = models.CharField(choices=WHATSAPP, max_length=15, verbose_name='Whatsapp')
...
class Image(models.Model):
    ...
    def __str__(self):
        return f"image de {self.evangelisation} publier le {self.publish}"from django.db import models
from django.utils.translation import gettext as _
from django.utils import timezone
from django.contrib.auth.models import User
from django.conf import settings
